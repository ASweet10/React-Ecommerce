...
const CategoryCards = () => {
  return (
    ...
    <div className='flex w-full h-full pt-14 md:px-40 justify-center bg-background'>
      <div className='grid md:grid-cols-3 grid-cols-2 text-white'>
        <div className='flex px-4 py-4 overflow-hidden'>
          <img className='w w-64 h-80 object-cover' src={furnitureImage} alt="" />
          <button className='absolute py-4 pl-4 my-64 border-none min-w-[100px] w-fit cursor-pointer font-medium text-2xl'>
        ...
        <div className='flex flex-col'>
          <div className='flex gap-3 mb-1 relative overflow-hidden'>
            <img className='w-56 h-[156px] object-cover' src={clothingImage} alt=""></img>
          ...
          <div className='flex relative mt-1 overflow-hidden'>
            <img className='w-56 h-[156px] object-cover' src={appliancesImage} alt=""></img>
            <button className='absolute p-3 my-24 border-none w-fit cursor-pointer font-medium text-2xl'>
