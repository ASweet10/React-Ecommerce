  ...
  return (
    <div className='w-full py-28 px-20 md:px-40 bg-background'>
        <div className='flex flex-row items-center justify-center mb-12'>
          <h1 className='capitalize font-bold text-2xl md:px-20'>Now Trending</h1>
        </div>

        <div className='flex flex-row justify-center'>
          <div className='flex flex-wrap gap-2'> {/* flex-wrap creates grid; horizontal layout without it */}
